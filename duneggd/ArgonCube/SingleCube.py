...
class SingleCubeBuilder(gegede.builder.Builder):
    """ Class to build SingleCube geometry.
    ...
    def construct(self,geom):
        ...
        print('SingleCubeBuilder::construct()')
        ...
        # Build TPC
        pos = [self.Fieldcage_dx-self.TPC_builder.halfDimension['dx']-self.Cathode_dx/2,Q('0cm'),-self.OpticalDet_builder.halfDimension['dz']]
        ...
        # Build OpticalDet
        pos = [self.Fieldcage_dx-self.TPC_builder.halfDimension['dx']*2-self.Cathode_dx/2+self.OpticalDet_builder.halfDimension['dx'],Q('0cm'),+self.TPC_builder.halfDimension['dz']]
